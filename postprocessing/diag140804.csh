...
set test_casename  = mycase
set test_filetype = monthly_history 
#set test_filetype = time_series

set test_path_history =  /glade/scratch/$USER/$test_casename/run/
set test_path_climo   =  $test_path_history
set test_path_diag    =  /glade/scratch/$USER/amwg/$test_casename/
...
set test_first_yr = 2000              # first year (must be >= 1)
