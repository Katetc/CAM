...
subcol_silhs_l_lh_importance_sampling = .true.
subcol_silhs_l_Lscale_vert_avg = .false.
subcol_silhs_l_lh_straight_mc = .false.
subcol_silhs_l_lh_clustered_sampling = .true.
subcol_silhs_l_rcm_in_cloud_k_lh_start = .true.
subcol_silhs_l_random_k_lh_start = .false.
subcol_silhs_l_max_overlap_in_cloud = .true.
subcol_silhs_l_lh_instant_var_covar_src = .true.
subcol_silhs_l_lh_limit_weights = .true.
subcol_silhs_l_lh_var_frac = .false.
subcol_silhs_l_lh_normalize_weights = .true.
